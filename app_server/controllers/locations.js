...
module.exports.locationInfo = function(req,res){
  res.render('location-info', {
    ...
    sidebar: {
      ...
      callToAction: 'If you\'ve been and you like it - or if you don\'t - please leave a review to help other people just like you.extends layout'
    },
    location: {
      name: 'Starcups',
      ...
      rating: 3,
      facilities: ['Hot drinks', 'Food', 'Premium wifi'],
      coords: {lat: 51.4455041, lng: -0.9690884},
      openingTimes: [{
        days: 'Monday - Friday ',
        opening: '7:00am',
        closing: '7:00pm',
